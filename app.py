...
def index():
    ...
    def standart2(X_train, X_test, new_df):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            (X_X_predict, X_train_scaled, X_test_scaled, X_predict_scaled, y_train, y_test, X_train, X_test, data,
             X_predict, X_predict_data, y_train_scaled, scaler_filename) = prediction_scaler(dataset)
            ...
            result = int(arange(result_model[0], prediction()[0]))
